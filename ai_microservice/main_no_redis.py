...
app = FastAPI(
    title="AI Resume Scorer - No Redis", 
    version="1.0.0",
    description="AI-powered resume scoring service (simplified version)"
)
