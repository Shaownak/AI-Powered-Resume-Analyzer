...
def send_notification_email(notification):
    ...
    try:
        ...
        email_templates = {
            ...
            "new_job_match": {"subject": f"New Job Match: {notification.job.title}", "template": "emails/new_job_match.html"},
        }
...
def notify_resume_scored(resume):
    ...
    if resume.applicant:
        return create_notification(
            recipient=resume.applicant, notification_type="resume_scored", title=title, message=message, job=resume.job
        )
